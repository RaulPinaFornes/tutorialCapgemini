...
public class CategoryController {
     ...
     */
    @Operation(summary = "Save or Update", description = "Method that saves or update a Categry")
     ...
     * @param id PK de la entidad
     */
    @Operation(summary = "Delete", description = "Method that deletes a Categry")
    @RequestMapping(path = "/{id}", method = RequestMethod.DELETE)
    public void deleteCategry(@PathVariable("id") Long id) {
